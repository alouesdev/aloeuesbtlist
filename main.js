  ...
  if(!message.guild || message.author.bot) return
	if (message.content === `site`) {
	  return message.channel.send(new Discord.MessageEmbed()
                                ...
                                .setDescription("Websitemiz için **[buraya](www.gliotbotlist.cf)** tıkla!"));
	}
  });
...
let joinc = "848863274438492211";
client.channels.cache.get(joinc).join();
client.user.setPresence({ activity: { type: 'WATCHING', name: 'www.gliotbotlist.cf' }, status: "dnd" });
})
